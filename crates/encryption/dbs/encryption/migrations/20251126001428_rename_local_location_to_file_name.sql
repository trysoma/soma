...
-- Note: local_location is renamed to local_file_name
INSERT INTO `new_envelope_encryption_key` (`id`, `key_type`, `local_file_name`, `aws_arn`, `aws_region`, `created_at`, `updated_at`) SELECT `id`, `key_type`, `local_location`, `aws_arn`, `aws_region`, `created_at`, `updated_at` FROM `envelope_encryption_key`;
