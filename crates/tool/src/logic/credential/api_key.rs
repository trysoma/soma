...
use crate::logic::{
    ConfigurationSchema, Metadata, CredentialSourceLike, ResourceServerCredentialLike,
    ResourceServerCredentialSerialized, StaticCredentialConfigurationLike,
    StaticCredentialSourceLike, UserCredentialLike, schemars_make_password,
};
...
impl StaticCredentialSourceLike for ApiKeySource {
...
#[async_trait]
impl CredentialSourceLike for ApiKeySource {
