...
use crate::logic::{
    ...
    ConfigurationSchema, Credential, Metadata, CredentialSourceLike,
    ResourceServerCredentialLike, ResourceServerCredentialSerialized,
    RotateableSourceUserCredentialLike, RotateableCredentialLike,
    StaticCredentialConfigurationLike, StaticCredentialSourceLike,
...
// ============================================================================
// OAuth Authorization Code Flow Source
// ============================================================================

pub struct OauthAuthFlowSource {
...
impl StaticCredentialSourceLike for OauthAuthFlowSource {
...
#[async_trait]
impl CredentialSourceLike for OauthAuthFlowSource {
...
#[async_trait]
impl UserCredentialBrokerLike for OauthAuthFlowSource {
    async fn start(
        &self,
...
#[async_trait]
impl RotateableSourceUserCredentialLike for OauthAuthFlowSource {
...
// ============================================================================
// OAuth JWT Bearer Assertion Flow Source
// ============================================================================

pub struct Oauth2JwtBearerAssertionFlowSource {
    pub static_credentials: Oauth2JwtBearerAssertionFlowStaticCredentialConfiguration,
}

impl Oauth2JwtBearerAssertionFlowSource {
    pub async fn decrypt_oauth_credentials(
        &self,
        crypto_service: &DecryptionService,
        user_credential: &UserCredentialSerialized,
...
impl StaticCredentialSourceLike for Oauth2JwtBearerAssertionFlowSource {
    fn static_type_id() -> &'static str {
...
#[async_trait]
impl CredentialSourceLike for Oauth2JwtBearerAssertionFlowSource {
    fn static_credentials(&self) -> &dyn StaticCredentialConfigurationLike {
        &self.static_credentials
    }
...
#[async_trait]
impl RotateableSourceUserCredentialLike for Oauth2JwtBearerAssertionFlowSource {
    async fn rotate_user_credential(
        &self,
        decryption_service: &DecryptionService,
        encryption_service: &EncryptionService,
...
mod tests {
    mod unit {
        ...
        async fn test_oauth_authorization_code_flow_rotate_user_credential() {
            ...
            let static_creds = source.static_credentials();

            // Verify the source can be used for rotation
            assert!(
                controller
                    .as_rotateable_source_user_credential()
                    .is_some()
            );
        ...
        async fn test_oauth_jwt_bearer_encrypt_decrypt_credentials() {
            ...
            let source = Oauth2JwtBearerAssertionFlowSource {
    ...
    mod integration {
        ...
        fn create_dex_static_credentials()
        ...
        #[integration_test]
        async fn test_oauth_source_type_id() {
            let source = OauthAuthFlowSource {
                static_credentials: create_dex_static_credentials(),
            };

            assert_eq!(source.type_id(), "oauth_auth_flow");
            assert_eq!(OauthAuthFlowSource::static_type_id(), "oauth_auth_flow");
        }

        #[integration_test]
        async fn test_oauth_source_documentation() {
            let source = OauthAuthFlowSource {
                static_credentials: create_dex_static_credentials(),
            };
        ...
        #[integration_test]
        async fn test_oauth_source_provides_broker() {
            let source = OauthAuthFlowSource {
                static_credentials: create_dex_static_credentials(),
            };

            // OAuth source should provide user credential broker
            assert!(
                source.as_user_credential_broker().is_some(),
                "OAuth source should provide user credential broker"
            );

            // OAuth source should provide rotateable credential support
            assert!(
                controller
                    .as_rotateable_source_user_credential()
                    .is_some(),
