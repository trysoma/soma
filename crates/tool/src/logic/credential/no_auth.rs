...
use crate::logic::{
    ConfigurationSchema, EncryptionService, Metadata, CredentialSourceLike,
    ResourceServerCredentialLike, StaticCredentialConfigurationLike,
    StaticCredentialSourceLike, UserCredentialLike,
};
...
pub struct NoAuthSource {
    pub static_credentials: NoAuthStaticCredentialConfiguration,
}

impl StaticCredentialSourceLike for NoAuthSource {
...
#[async_trait]
impl CredentialSourceLike for NoAuthSource {
