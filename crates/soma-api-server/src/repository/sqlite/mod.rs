...
mod tests {
    mod unit {
        ...
        use crate::logic::task::{
            ...
            TaskEventUpdateType, TaskStatus, TaskStatusUpdateTaskTimelineItem,
            TaskTimelineItemPayload, TextPart,
        };
        use crate::repository::{
        ...
        async fn test_get_task_timeline_items_pagination() {
            ...
            for i in 0..5 {
                ...
                let (event_type, event_payload) = if i % 2 == 0 {
                    ...
                    let payload =
                        TaskTimelineItemPayload::Message(MessageTaskTimelineItem { message });
                    (
                    ...
                    let payload = TaskTimelineItemPayload::TaskStatusUpdate(
