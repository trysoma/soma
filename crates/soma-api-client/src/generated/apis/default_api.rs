...
/// struct for typed errors of method [`migrate_encryption_key`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MigrateEncryptionKeyError {
    Status400(models::Error),
    Status500(models::Error),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_resource_server_credential(configuration: &configuration::Configuration, provider_controller_type_id: &str, credential_controller_type_id: &str, create_resource_server_credential_params_inner: models::CreateResourceServerCredentialParamsInner) -> Result<models::ResourceServerCredentialSerialized, Error<CreateResourceServerCredentialError>> {
    ...
    let p_path_provider_controller_type_id = provider_controller_type_id;
    let p_path_credential_controller_type_id = credential_controller_type_id;
    let p_body_create_resource_server_credential_params_inner = create_resource_server_credential_params_inner;
...
pub async fn delete_provider_instance(configuration: &configuration::Configuration, provider_instance_id: &str) -> Result<serde_json::Value, Error<DeleteProviderInstanceError>> {
    ...
    let uri_str = format!("{}/api/bridge/v1/provider/{provider_instance_id}", configuration.base_path, provider_instance_id=crate::apis::urlencode(p_path_provider_instance_id));
...
pub async fn disable_function(configuration: &configuration::Configuration, provider_instance_id: &str, function_controller_type_id: &str) -> Result<serde_json::Value, Error<DisableFunctionError>> {
    ...
    let uri_str = format!("{}/api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/disable", configuration.base_path, provider_instance_id=crate::apis::urlencode(p_path_provider_instance_id), function_controller_type_id=crate::apis::urlencode(p_path_function_controller_type_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn enable_function(configuration: &configuration::Configuration, provider_instance_id: &str, function_controller_type_id: &str, body: serde_json::Value) -> Result<models::FunctionInstanceSerialized, Error<EnableFunctionError>> {
    ...
    let uri_str = format!("{}/api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/enable", configuration.base_path, provider_instance_id=crate::apis::urlencode(p_path_provider_instance_id), function_controller_type_id=crate::apis::urlencode(p_path_function_controller_type_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn encrypt_resource_server_configuration(configuration: &configuration::Configuration, provider_controller_type_id: &str, credential_controller_type_id: &str, encrypt_credential_configuration_params_inner: models::EncryptCredentialConfigurationParamsInner) -> Result<serde_json::Value, Error<EncryptResourceServerConfigurationError>> {
    ...
    let p_path_provider_controller_type_id = provider_controller_type_id;
    let p_path_credential_controller_type_id = credential_controller_type_id;
    let p_body_encrypt_credential_configuration_params_inner = encrypt_credential_configuration_params_inner;
...
pub async fn get_function_instances_openapi_spec(configuration: &configuration::Configuration, ) -> Result<String, Error<GetFunctionInstancesOpenapiSpecError>> {

    let uri_str = format!("{}/api/bridge/v1/function-instances/openapi.json", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetFunctionInstancesOpenapiSpecError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_internal_runtime_config(configuration: &configuration::Configuration, ) -> Result<serde_json::Value, Error<GetInternalRuntimeConfigError>> {
...
pub async fn get_task_by_id(configuration: &configuration::Configuration, task_id: &str) -> Result<models::TaskWithDetails, Error<GetTaskByIdError>> {
    ...
    let uri_str = format!("{}/api/task/v1/{task_id}", configuration.base_path, task_id=crate::apis::urlencode(p_path_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn invoke_function(configuration: &configuration::Configuration, provider_instance_id: &str, function_controller_type_id: &str, invoke_function_params_inner: models::InvokeFunctionParamsInner) -> Result<models::InvokeResult, Error<InvokeFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_provider_instance_id = provider_instance_id;
    let p_path_function_controller_type_id = function_controller_type_id;
    let p_body_invoke_function_params_inner = invoke_function_params_inner;

    let uri_str = format!("{}/api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/invoke", configuration.base_path, provider_instance_id=crate::apis::urlencode(p_path_provider_instance_id), function_controller_type_id=crate::apis::urlencode(p_path_function_controller_type_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::InvokeResult`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::InvokeResult`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn list_tasks_by_context_id(configuration: &configuration::Configuration, page_size: i64, context_id: &str, next_page_token: Option<&str>) -> Result<models::TaskPaginatedResponse, Error<ListTasksByContextIdError>> {
    ...
    let uri_str = format!("{}/api/task/v1/context/{context_id}/task", configuration.base_path, context_id=crate::apis::urlencode(p_path_context_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn migrate_encryption_key(configuration: &configuration::Configuration, migrate_encryption_key_params: models::MigrateEncryptionKeyParams) -> Result<models::MigrateEncryptionKeyResponse, Error<MigrateEncryptionKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_migrate_encryption_key_params = migrate_encryption_key_params;

    let uri_str = format!("{}/api/bridge/v1/encryption/migrate", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    req_builder = req_builder.json(&p_body_migrate_encryption_key_params);
...
pub async fn send_message(configuration: &configuration::Configuration, task_id: &str, create_message_request: models::CreateMessageRequest) -> Result<models::CreateMessageResponse, Error<SendMessageError>> {
    ...
    let uri_str = format!("{}/api/task/v1/{task_id}/message", configuration.base_path, task_id=crate::apis::urlencode(p_path_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn start_user_credential_brokering(configuration: &configuration::Configuration, provider_controller_type_id: &str, credential_controller_type_id: &str, start_user_credential_brokering_params_inner: models::StartUserCredentialBrokeringParamsInner) -> Result<models::UserCredentialBrokeringResponse, Error<StartUserCredentialBrokeringError>> {
    ...
    let p_path_provider_controller_type_id = provider_controller_type_id;
    let p_path_credential_controller_type_id = credential_controller_type_id;
    let p_body_start_user_credential_brokering_params_inner = start_user_credential_brokering_params_inner;
...
pub async fn task_history(configuration: &configuration::Configuration, page_size: i64, task_id: &str, next_page_token: Option<&str>) -> Result<models::TaskTimelineItemPaginatedResponse, Error<TaskHistoryError>> {
    ...
    let uri_str = format!("{}/api/task/v1/{task_id}/timeline", configuration.base_path, task_id=crate::apis::urlencode(p_path_task_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn trigger_codegen(configuration: &configuration::Configuration, ) -> Result<models::TriggerCodegenResponse, Error<TriggerCodegenError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::TriggerCodegenResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::TriggerCodegenResponse`")))),
        }
    } else {
        let content = resp.text().await?;
