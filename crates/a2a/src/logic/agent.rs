...
/// Repository-backed implementation of the A2A TaskStore trait
...
impl TaskStore for RepositoryTaskStore {
    ...
    async fn get(&self, id: &TaskId) -> Result<Option<Task>, A2aServerError> {
        ...
        // Convert status_message to a2a_core::types::Message if present
    ...
    async fn delete(&self, _id: &TaskId) -> Result<(), A2aServerError> {
        ...
        Err(A2aServerError::InternalError(a2a_core::errors::Error {
...
pub fn construct_agent_card(params: ConstructAgentCardParams) -> a2a_core::types::AgentCard {
    let _definition = params.definition;
    let url = params.url;

    AgentCard {
        additional_interfaces: vec![],
        capabilities: a2a_core::types::AgentCapabilities {
            streaming: Some(true),
