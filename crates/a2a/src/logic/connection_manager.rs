...
pub struct Connection {
    ...
    pub sender: Sender<a2a_core::events::Event>,
}
...
impl ConnectionManager {
    ...
    ) -> Result<(WrappedUuidV4, Receiver<a2a_core::events::Event>), CommonError> {
        let connection_id = WrappedUuidV4::new();
        let (sender, receiver) = tokio::sync::mpsc::channel::<a2a_core::events::Event>(100);
