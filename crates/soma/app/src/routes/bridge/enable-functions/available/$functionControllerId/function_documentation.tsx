...
export const Route = createFileRoute('/bridge/enable-functions/available/$functionControllerId/function_documentation')({
  component: RouteComponent,
})

function RouteComponent() {
  const { functionControllerId } = useParams({ from: '/bridge/enable-functions/available/$functionControllerId/function_documentation' });
