...
export const Route = createFileRoute('/bridge/enable-functions/available/$functionControllerId/provider_documentation')({
  component: RouteComponent,
})

function RouteComponent() {
  const { functionControllerId } = useParams({ from: '/bridge/enable-functions/available/$functionControllerId/provider_documentation' });
