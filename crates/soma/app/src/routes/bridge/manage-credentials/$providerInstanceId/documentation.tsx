...
export const Route = createFileRoute('/bridge/manage-credentials/$providerInstanceId/documentation')({
  component: RouteComponent,
})

function RouteComponent() {
  const { providerInstanceId } = useParams({ from: '/bridge/manage-credentials/$providerInstanceId/documentation' });
