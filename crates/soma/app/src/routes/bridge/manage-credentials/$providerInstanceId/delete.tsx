...
function RouteComponent() {
  const { providerInstanceId } = useParams({ from: '/bridge/manage-credentials/$providerInstanceId/delete' });
  ...
  // Delete mutation
  const deleteMutation = $api.useMutation("delete", "/api/bridge/v1/provider/{provider_instance_id}");
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            This will permanently delete these credentials and all associated configurations.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 ml-2">
                  ...
                  <li>Disable all functions currently using these credentials</li>
            ...
            <div className="pt-2">
              ...
              >
                ...
                {isDeleting ? "Deleting..." : `Delete "${instance.display_name}"`}
              </Button>
            </div>
          </div>
        </div>
