...
/// Runs the bridge sync to YAML loop - listens for bridge config changes and syncs to soma.yaml
pub async fn run_bridge_sync_to_yaml_loop(
    ...
    debug!("Bridge sync to YAML loop started");
