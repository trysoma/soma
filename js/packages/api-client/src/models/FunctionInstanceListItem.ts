 ...
 */
export function instanceOfFunctionInstanceListItem(
	value: object,
): value is FunctionInstanceListItem {
...
export function FunctionInstanceListItemFromJSON(
	json: any,
): FunctionInstanceListItem {
	return FunctionInstanceListItemFromJSONTyped(json, false);
}

export function FunctionInstanceListItemFromJSONTyped(
	json: any,
...
export function FunctionInstanceListItemToJSON(
	json: any,
): FunctionInstanceListItem {
	return FunctionInstanceListItemToJSONTyped(json, false);
}

export function FunctionInstanceListItemToJSONTyped(
	value?: FunctionInstanceListItem | null,
