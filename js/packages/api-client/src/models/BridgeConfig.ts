...
import {
    ...
    ProviderConfigFromJSONTyped,
    ProviderConfigToJSON,
    ProviderConfigToJSONTyped,
} from './ProviderConfig';
...
export function BridgeConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): BridgeConfig {
    ...
    return {
        ...
        'providers': json['providers'] == null ? undefined : (mapValues(json['providers'], ProviderConfigFromJSON)),
    };
}
...
export function BridgeConfigToJSONTyped(value?: BridgeConfig | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'providers': value['providers'] == null ? undefined : (mapValues(value['providers'], ProviderConfigToJSON)),
    };
}
