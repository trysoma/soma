...
export function BrokerStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrokerState {
    if (json == null) {
        return json;
    }
    return {
...
export function BrokerStateToJSONTyped(value?: BrokerState | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
