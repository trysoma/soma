...
export interface TaskApiListContextsRequest {
	pageSize: number;
...
export interface TaskApiListTasksByContextIdRequest {
	pageSize: number;
	contextId: string;
	nextPageToken?: string;
}

export interface TaskApiSendMessageRequest {
	taskId: string;
	createMessageRequest: CreateMessageRequest;
}

export interface TaskApiTaskHistoryRequest {
	pageSize: number;
	taskId: string;
	nextPageToken?: string;
}

export interface TaskApiUpdateTaskStatusOperationRequest {
	taskId: string;
...
export class TaskApi extends runtime.BaseAPI {
	...
	async getTaskByIdRaw(
		requestParameters: TaskApiGetTaskByIdRequest,
	...
	async listContextsRaw(
		requestParameters: TaskApiListContextsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	 ...
	 */
	async listTasksRaw(
		requestParameters: TaskApiListTasksRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async listTasksByContextIdRaw(
		requestParameters: TaskApiListTasksByContextIdRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<TaskPaginatedResponse>> {
		if (requestParameters.pageSize == null) {
			throw new runtime.RequiredError(
	...
	async sendMessageRaw(
		requestParameters: TaskApiSendMessageRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async taskHistoryRaw(
		requestParameters: TaskApiTaskHistoryRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async updateTaskStatusRaw(
		requestParameters: TaskApiUpdateTaskStatusOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
