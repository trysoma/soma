...
export interface SecretApiCreateSecretOperationRequest {
	createSecretRequest: CreateSecretRequest;
}

export interface SecretApiDeleteSecretRequest {
	secretId: string;
}

export interface SecretApiGetSecretByIdRequest {
	secretId: string;
}

export interface SecretApiGetSecretByKeyRequest {
	key: string;
}

export interface SecretApiImportSecretOperationRequest {
	importSecretRequest: ImportSecretRequest;
}

export interface SecretApiListDecryptedSecretsRequest {
	pageSize: number;
	nextPageToken?: string;
}

export interface SecretApiListSecretsRequest {
	pageSize: number;
	nextPageToken?: string;
}

export interface SecretApiUpdateSecretOperationRequest {
	secretId: string;
...
export class SecretApi extends runtime.BaseAPI {
	...
	async createSecretRaw(
		requestParameters: SecretApiCreateSecretOperationRequest,
	...
	async deleteSecretRaw(
		requestParameters: SecretApiDeleteSecretRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async getSecretByIdRaw(
		requestParameters: SecretApiGetSecretByIdRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Secret>> {
		if (requestParameters.secretId == null) {
			throw new runtime.RequiredError(
	...
	async getSecretByKeyRaw(
		requestParameters: SecretApiGetSecretByKeyRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Secret>> {
	...
	async importSecretRaw(
		requestParameters: SecretApiImportSecretOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Secret>> {
	...
	async listDecryptedSecretsRaw(
		requestParameters: SecretApiListDecryptedSecretsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async listSecretsRaw(
		requestParameters: SecretApiListSecretsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	...
	async updateSecretRaw(
		requestParameters: SecretApiUpdateSecretOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction,
	): Promise<runtime.ApiResponse<Secret>> {
		if (requestParameters.secretId == null) {
			throw new runtime.RequiredError(
