...
```typescript
import type { ProviderInstanceSerializedWithCredentials } from '@trysoma/api-client'
...
const example = {
  ...
  "userCredential": null,
} satisfies ProviderInstanceSerializedWithCredentials
...
const exampleParsed = JSON.parse(exampleJSON) as ProviderInstanceSerializedWithCredentials
