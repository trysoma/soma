...
|------------- | ------------- | -------------|
| [**createDataEncryptionKey**](V1Api.md#createdataencryptionkey) | **POST** /api/encryption/v1/envelope/{envelope_id}/dek | Create data key |
| [**createDekAlias**](V1Api.md#createdekaliasoperation) | **POST** /api/encryption/v1/dek/alias | Create DEK alias |
| [**createEnvelopeEncryptionKey**](V1Api.md#createenvelopeencryptionkey) | **POST** /api/encryption/v1/envelope | Create envelope key |
| [**createProviderInstance**](V1Api.md#createproviderinstance) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id} | Create provider |
| [**createResourceServerCredential**](V1Api.md#createresourceservercredential) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id}/credential/resource-server | Create resource server credential |
| [**createSecret**](V1Api.md#createsecretoperation) | **POST** /api/secret/v1 | Create secret |
| [**createUserCredential**](V1Api.md#createusercredential) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id}/credential/user-credential | Create user credential |
| [**deleteDekAlias**](V1Api.md#deletedekalias) | **DELETE** /api/encryption/v1/dek/alias/{alias} | Delete DEK alias |
| [**deleteProviderInstance**](V1Api.md#deleteproviderinstance) | **DELETE** /api/bridge/v1/provider/{provider_instance_id} | Delete provider |
| [**deleteSecret**](V1Api.md#deletesecret) | **DELETE** /api/secret/v1/{secret_id} | Delete secret |
| [**disableFunction**](V1Api.md#disablefunction) | **POST** /api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/disable | Disable function |
| [**enableFunction**](V1Api.md#enablefunction) | **POST** /api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/enable | Enable function |
| [**encryptResourceServerConfiguration**](V1Api.md#encryptresourceserverconfiguration) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id}/credential/resource-server/encrypt | Encrypt resource server config |
| [**encryptUserCredentialConfiguration**](V1Api.md#encryptusercredentialconfiguration) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id}/credential/user-credential/encrypt | Encrypt user credential config |
| [**getAgentCard**](V1Api.md#getagentcard) | **GET** /api/a2a/v1/.well-known/agent.json | Get agent card |
| [**getAgentDefinition**](V1Api.md#getagentdefinition) | **GET** /api/a2a/v1/definition | Get agent definition |
| [**getDekByAliasOrId**](V1Api.md#getdekbyaliasorid) | **GET** /api/encryption/v1/dek/alias/{alias} | Get DEK by alias |
| [**getExtendedAgentCard**](V1Api.md#getextendedagentcard) | **GET** /api/a2a/v1/agent/authenticatedExtendedCard | Get extended agent card |
| [**getFunctionInstancesOpenapiSpec**](V1Api.md#getfunctioninstancesopenapispec) | **GET** /api/bridge/v1/function-instances/openapi.json | Get function OpenAPI spec |
| [**getInternalRuntimeConfig**](V1Api.md#getinternalruntimeconfig) | **GET** /_internal/v1/runtime_config | Get runtime config |
| [**getProviderInstance**](V1Api.md#getproviderinstance) | **GET** /api/bridge/v1/provider/{provider_instance_id} | Get provider |
| [**getSecretById**](V1Api.md#getsecretbyid) | **GET** /api/secret/v1/{secret_id} | Get secret |
| [**getSecretByKey**](V1Api.md#getsecretbykey) | **GET** /api/secret/v1/key/{key} | Get secret by key |
| [**getTaskById**](V1Api.md#gettaskbyid) | **GET** /api/task/v1/{task_id} | Get task |
| [**handleJsonrpcRequest**](V1Api.md#handlejsonrpcrequest) | **POST** /api/a2a/v1 | Handle JSON-RPC |
| [**healthCheck**](V1Api.md#healthcheck) | **GET** /_internal/v1/health | Health check |
| [**importDataEncryptionKey**](V1Api.md#importdataencryptionkey) | **POST** /api/encryption/v1/envelope/{envelope_id}/dek/import | Import data key |
| [**importSecret**](V1Api.md#importsecretoperation) | **POST** /api/secret/v1/import | Import secret |
| [**invokeFunction**](V1Api.md#invokefunction) | **POST** /api/bridge/v1/provider/{provider_instance_id}/function/{function_controller_type_id}/invoke | Invoke function |
| [**listAvailableProviders**](V1Api.md#listavailableproviders) | **GET** /api/bridge/v1/available-providers | List providers |
| [**listContexts**](V1Api.md#listcontexts) | **GET** /api/task/v1/context | List contexts |
| [**listDataEncryptionKeysByEnvelope**](V1Api.md#listdataencryptionkeysbyenvelope) | **GET** /api/encryption/v1/envelope/{envelope_id}/dek | List data keys |
| [**listDecryptedSecrets**](V1Api.md#listdecryptedsecrets) | **GET** /api/secret/v1/list-decrypted | List decrypted secrets |
| [**listEnvelopeEncryptionKeys**](V1Api.md#listenvelopeencryptionkeys) | **GET** /api/encryption/v1/envelope | List envelope keys |
| [**listFunctionInstances**](V1Api.md#listfunctioninstances) | **GET** /api/bridge/v1/function-instances | List function instances |
| [**listProviderInstances**](V1Api.md#listproviderinstances) | **GET** /api/bridge/v1/provider | List provider instances |
| [**listProviderInstancesGroupedByFunction**](V1Api.md#listproviderinstancesgroupedbyfunction) | **GET** /api/bridge/v1/provider/grouped-by-function | List providers by function |
| [**listSecrets**](V1Api.md#listsecrets) | **GET** /api/secret/v1 | List secrets |
| [**listTasks**](V1Api.md#listtasks) | **GET** /api/task/v1 | List tasks |
| [**listTasksByContextId**](V1Api.md#listtasksbycontextid) | **GET** /api/task/v1/context/{context_id}/task | List tasks by context |
| [**listenToMcpSse**](V1Api.md#listentomcpsse) | **GET** /api/bridge/v1/mcp | MCP SSE connection |
| [**migrateAllDataEncryptionKeys**](V1Api.md#migratealldataencryptionkeys) | **POST** /api/encryption/v1/envelope/{envelope_id}/migrate | Migrate all data keys |
| [**migrateDataEncryptionKey**](V1Api.md#migratedataencryptionkey) | **POST** /api/encryption/v1/envelope/{envelope_id}/dek/{dek_id}/migrate | Migrate data key |
| [**resumeUserCredentialBrokering**](V1Api.md#resumeusercredentialbrokering) | **GET** /api/bridge/v1/generic-oauth-callback | OAuth callback |
| [**sendMessage**](V1Api.md#sendmessage) | **POST** /api/task/v1/{task_id}/message | Send message |
| [**startUserCredentialBrokering**](V1Api.md#startusercredentialbrokering) | **POST** /api/bridge/v1/available-providers/{provider_controller_type_id}/available-credentials/{credential_controller_type_id}/credential/user-credential/broker | Start credential brokering |
| [**taskHistory**](V1Api.md#taskhistory) | **GET** /api/task/v1/{task_id}/timeline | Get task timeline |
| [**triggerCodegen**](V1Api.md#triggercodegen) | **POST** /_internal/v1/trigger_codegen | Trigger codegen |
| [**triggerMcpMessage**](V1Api.md#triggermcpmessage) | **POST** /api/bridge/v1/mcp | Send MCP message |
| [**updateDekAlias**](V1Api.md#updatedekalias) | **PUT** /api/encryption/v1/dek/alias/{alias} | Update DEK alias |
| [**updateProviderInstance**](V1Api.md#updateproviderinstance) | **PATCH** /api/bridge/v1/provider/{provider_instance_id} | Update provider |
| [**updateSecret**](V1Api.md#updatesecretoperation) | **PUT** /api/secret/v1/{secret_id} | Update secret |
| [**updateTaskStatus**](V1Api.md#updatetaskstatusoperation) | **PUT** /api/task/v1/{task_id} | Update task status |
