...
class CreateMessageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["message", "timeline_item"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of timeline_item
        if self.timeline_item:
            _dict["timeline_item"] = self.timeline_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "message": Message.from_dict(obj["message"])
                if obj.get("message") is not None
                else None,
                "timeline_item": TaskTimelineItem.from_dict(obj["timeline_item"])
                if obj.get("timeline_item") is not None
                else None,
            }
        )
        return _obj
