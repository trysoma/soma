...
class ScimUserGroup(BaseModel):
    ...
    value: StrictStr
    __properties: ClassVar[List[str]] = ["$ref", "display", "type", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScimUserGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScimUserGroup from a dict"""
        if obj is None:
            return None
